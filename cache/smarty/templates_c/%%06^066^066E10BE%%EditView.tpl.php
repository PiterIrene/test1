<?php /* Smarty version 2.6.29, created on 2016-12-03 13:22:44
         compiled from cache/themes/SuiteP/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 45, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 92, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 473, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 575, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 54, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 75, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 97, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 98, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 278, false),array('function', 'sugar_number_format', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 390, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 710, false),)), $this); ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_VIP','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php if (strval ( $this->_tpl_vars['fields']['vip']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['vip']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['vip']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['vip']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['vip']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['vip']['name']; ?>
" 
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAY','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php if (strlen ( $this->_tpl_vars['fields']['pay']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['pay']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['pay']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['pay']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['pay']['name']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SOCIAL_NET','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php if (! empty ( $this->_tpl_vars['fields']['social_net']['value'] )): ?>
<input type='text' name='<?php echo $this->_tpl_vars['fields']['social_net']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['social_net']['name']; ?>
' size='30' 
maxlength='100' value='<?php echo $this->_tpl_vars['fields']['social_net']['value']; ?>
' title='' tabindex=''  >
<?php else: ?>
<input type='text' name='<?php echo $this->_tpl_vars['fields']['social_net']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['social_net']['name']; ?>
' size='30' 
maxlength='100'	   	   <?php if ($this->_tpl_vars['displayView'] == 'advanced_search' || $this->_tpl_vars['displayView'] == 'basic_search'): ?>value=''<?php else: ?>value='http://'<?php endif; ?> 
title='' tabindex=''  >
<?php endif; ?>
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSITION','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
"category","<?php echo $this->_tpl_vars['fields']['position']['name']; ?>
"<?php echo ')}'; ?>
);
...
<td width="*">
<textarea id="primary_address_street" name="primary_address_street" maxlength="150" rows="2" cols="30" tabindex=""><?php echo $this->_tpl_vars['fields']['primary_address_street']['value']; ?>
</textarea>
</td>
</tr>
<tr>
...
<td width="*">
<textarea id="alt_address_street" name="alt_address_street" maxlength="150" rows="2" cols="30" tabindex=""><?php echo $this->_tpl_vars['fields']['alt_address_street']['value']; ?>
</textarea>
</td>
</tr>
<tr>
...
" class="sqsEnabled" tabindex="" id="<?php echo $this->_tpl_vars['fields']['report_to_name']['name']; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'vip\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_VIP','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'social_net\', \'url\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SOCIAL_NET','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidateRange(\'EditView\', \'pay\', \'int\', false, \''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\', 0, 200000);
addToValidate(\'EditView\', \'category\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'position\', \'dynamicenum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSITION','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
