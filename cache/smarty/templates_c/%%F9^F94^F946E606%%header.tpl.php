<?php /* Smarty version 2.6.29, created on 2016-12-01 06:55:10
...
<div id="bootstrap-container"
     class="<?php if ($this->_tpl_vars['THEME_CONFIG']['display_sidebar'] && $_COOKIE['sidebartoggle'] != 'collapsed'): ?>col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2<?php endif; ?> main">
    <div id="content">
        <div id="pagecontent">
<?php endif; ?>