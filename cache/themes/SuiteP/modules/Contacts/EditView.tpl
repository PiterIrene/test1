...
{capture name="label" assign="label"}{sugar_translate label='LBL_VIP' module='Contacts'}{/capture}
{$label|strip_semicolon}:

</div>
<!-- VALUE -->
<div class="col-xs-12 col-sm-8 edit-view-field " type="bool" field="vip"  >
{counter name="panelFieldCount" print=false}

{if strval($fields.vip.value) == "1" || strval($fields.vip.value) == "yes" || strval($fields.vip.value) == "on"} 
{assign var="checked" value='checked="checked"'}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.vip.name}" value="0"> 
<input type="checkbox" id="{$fields.vip.name}" 
name="{$fields.vip.name}" 
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PAY' module='Contacts'}{/capture}
{$label|strip_semicolon}:

</div>
<!-- VALUE -->
<div class="col-xs-12 col-sm-8 edit-view-field " type="int" field="pay"  >
{counter name="panelFieldCount" print=false}

{if strlen($fields.pay.value) <= 0}
{assign var="value" value=$fields.pay.default_value }
{else}
{assign var="value" value=$fields.pay.value }
{/if}  
<input type='text' name='{$fields.pay.name}' 
id='{$fields.pay.name}' size='30' maxlength='10' value='{sugar_number_format precision=0 var=$value}' title='' tabindex=''    >
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SOCIAL_NET' module='Contacts'}{/capture}
{$label|strip_semicolon}:

</div>
<!-- VALUE -->
<div class="col-xs-12 col-sm-8 edit-view-field " type="url" field="social_net" colspan='3' >
{counter name="panelFieldCount" print=false}

{if !empty($fields.social_net.value)}
<input type='text' name='{$fields.social_net.name}' id='{$fields.social_net.name}' size='30' 
maxlength='100' value='{$fields.social_net.value}' title='' tabindex=''  >
{else}
<input type='text' name='{$fields.social_net.name}' id='{$fields.social_net.name}' size='30' 
maxlength='100'	   	   {if $displayView=='advanced_search'||$displayView=='basic_search'}value=''{else}value='http://'{/if} 
title='' tabindex=''  >
{/if}
</div>
...
<!-- VALUE -->
<div class="col-xs-12 col-sm-8 edit-view-field " type="dynamicenum" field="position"  >
{counter name="panelFieldCount" print=false}
...
<script type="text/javascript">
    ...
    addLoadEvent(function(){literal}{loadDynamicEnum({/literal}"category","{$fields.position.name}"{literal})}{/literal});
    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded) {literal}{loadDynamicEnum({/literal}"category","{$fields.position.name}"{literal})}{/literal}
</script>
</div>
...
<td width="*">
<textarea id="primary_address_street" name="primary_address_street" maxlength="150" rows="2" cols="30" tabindex="">{$fields.primary_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength='150' value='{$fields.primary_address_city.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength='150' value='{$fields.primary_address_state.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength='150' value='{$fields.primary_address_postalcode.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="primary_address_country" id="primary_address_country" size="30" maxlength='150' value='{$fields.primary_address_country.value}' tabindex="">
</td>
</tr>
<tr>
...
<td width="*">
<textarea id="alt_address_street" name="alt_address_street" maxlength="150" rows="2" cols="30" tabindex="">{$fields.alt_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength='150' value='{$fields.alt_address_city.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength='150' value='{$fields.alt_address_state.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength='150' value='{$fields.alt_address_postalcode.value}' tabindex="">
</td>
</tr>
<tr>
...
<td>
<input type="text" name="alt_address_country" id="alt_address_country" size="30" maxlength='150' value='{$fields.alt_address_country.value}' tabindex="">
</td>
</tr>
<tr>
<td scope='row' NOWRAP>
...
<input type="text" name="{$fields.report_to_name.name}" class="sqsEnabled" tabindex="" id="{$fields.report_to_name.name}" size="" value="{$fields.report_to_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.report_to_name.id_name}" 
id="{$fields.report_to_name.id_name}" 
value="{$fields.reports_to_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.report_to_name.name}" id="btn_{$fields.report_to_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.report_to_name.name}" id="btn_clr_{$fields.report_to_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE"}"  class="button lastChild"
...
addToValidate('EditView', 'vip', 'bool', false,'{/literal}{sugar_translate label='LBL_VIP' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'social_net', 'url', false,'{/literal}{sugar_translate label='LBL_SOCIAL_NET' module='Contacts' for_js=true}{literal}' );
addToValidateRange('EditView', 'pay', 'int', false, '{/literal}{sugar_translate label='LBL_PAY' module='Contacts' for_js=true}{literal}', 0, 200000);
addToValidate('EditView', 'category', 'enum', false,'{/literal}{sugar_translate label='LBL_CATEGORY' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'position', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_POSITION' module='Contacts' for_js=true}{literal}' );
